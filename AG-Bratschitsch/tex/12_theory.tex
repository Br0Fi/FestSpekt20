...
\subsection{Magneto-optic effect}
  ...
  with $\eta_\text{F}$ being the ellipticity of the polarization.
	The initial linearly polarized light $\hat{E}_i$ can be written as a two-component vector: %TODO eher "the electric field of initially linearly polarized light" ?
	\begin{align*}
		\hat{E}_i = \left( \begin{array}{r}
				...
				\end{array}\right) \,,
	\end{align*}
	where $p$ describes the lights polarization. %TODO wenn ich das richtig verstehe, ist p der Winkel, in dem das linear polarisiert ist. ich würde schreiben: "describes the angle of the linear polarization"
  ...
  Specifically, $E_i \propto \text{Jones matrices} \cdot \hat{E}_i$. %TODO das sieht sehr merkwürdig aus. Vielleicht "Jones matrices" in [] setzen? Oder einfach sagen, dass die Jones matrices J_k sind mit k vortlaufendem Index und dann als Produkt mit großem Pi schreiben:
  %  E_i = (\prod_k J_k ) \cdot \hat{E}_i
  %TODO außerdem: wofür ist das i in E_i gut?
