...
Removing the mirror and using the white light source (light blue lines) to illuminate the sample allows taking visuals of the sample.
With this, navigation to previously observed spots is possible.
The filter are added to reduce noise from the laser which would add to the photoluminescence spectrum.
%TODO dürfte jetzt passen ------ da noch was beschreibendes zu
