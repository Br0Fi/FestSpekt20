...
Both beams are then focused on different rows on the CCD-chip, which acts as a spectrometer. %TODO Gitter
...
According to the theoretical description in \cref{sec:theory}, measuring at a certain initial beam polarization allows us to obtain the Faraday rotation, however with background. %TODO wieso initial beam polarization? man misst doch nicht das initiale?
...
Here, it also shows that the minimum at \SI{0.75}{\tesla} is a little of the expected value- %TODO ?
