...
\section{Conclusion}
  ...
  %In the future it might be possible to reduce stress on the sample, by performing not performing several antibunching measurements of the same emitter at high laser powers, before measuring spectra.
