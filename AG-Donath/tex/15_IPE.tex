...
Die unbesetzte elektronische Struktur wird dabei im Allgemeinen in normaler und CDW Phase untersucht. %TODO habe ich von ihm gecopypasted, ich verstehe nur das "im Allgemeinen" nicht.
...
%TODO Wie werden die Photonen denn detektiert? Ist die Detektionsenergie variabel oder fest? Wie sieht es mit der Energie der einfallenden Elektronen aus?
...
Die an der Probe gebeugten Elektronen treffen auf einen LEED-Schirm, welcher aus mehreren Gittern und einem Leuchtschirm besteht.
...
Sobald dies der Fall ist wird die IPE-Messung durchgeführt. %, wird die Probe unter \SI{200}{\kelvin} (auf ca. \SI{190}{\kelvin}) gekühlt und die IPE-Messung durchgeführt.
...
%TODO "Die Probe wurde gar nicht unterhalb der kritischen Temperatur gekühlt und der CDW-rückgefaltete Zustand wird hier gar nicht erwartet"
% Ich habe hier in der Diskussion noch nichts geändert, weil ich mir unsicher bin, was man dann hier sehen sollte. (Es sei denn, die Antwort ist nichts.)
