...
Zu diesem Zweck wird ein Kupferkristall verwendet, da er in einer (111)-Orientierung und einem Einstrahlwinkel von \SI{12}{\degree} einen sehr markanten Oberflächenzustand besitzt, welcher bei \SI{0}{\degree} verschwindet.
...
Erkennbar ist jedoch auch, dass dieser bei \SI{0}{\degree} nicht verschwindet, aber ein deutlich kleineres Verhältnis zum Hintergrundrauschen aufweist.
...
\end{figure}
Hier lassen sich % TODO erkennen.
