...
\subsection{Aufbau \& Durchführung}
  ...
  Zur Kalibration wird als Probe ein Spiegel verwendet. %TODO Spiegel genauer?
  So werden die optischen Elemente so ausgerichtet, dass das gemessene Signal maximiert wird.
  Um möglichst empfindlich gegenüber Änderungen der Polarisation zu sein, wird der Polarisationsfilter, der als Analysator verwendet wird in einen \SI{45}{\degree}-Winkel zum Polarisator gebracht, indem der Mittelpunkt zwischen maximaler und minimaler Transmission eingestellt wird.
...
\end{figure}
  ...
  In \cref{fig_raw_cro} ist das Ergebnis der Messung der CrO$_2$-Probe dargestellt.
  ...
  Um dies zu korrigieren werden zunächst alle Messungen über ihren so angepasst, dass die Durchschnittliche Intensität der Messungen (für auf- und absteigende Messungen einzeln) konstant ist.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.495\textwidth}
        ...
        \caption{CoPt}
    \end{subfigure}
    \caption{Gegen den thermischen Drift korrigierte Messungen der Hysteresekurven von CrO$_2$ und CoPt. \enquote{up} steht für steigende und \enquote{down} für fallende Magnetfeldstärke. Die Unsicherheiten wurden zugunsten der Übersicht nicht dargestellt.}
